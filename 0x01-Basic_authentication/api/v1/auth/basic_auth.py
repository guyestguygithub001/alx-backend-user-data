#!/usr/bin/env python3
"""This script handles basic authentication."""
import base64
...
class BasicAuth(Auth):
    """This class defines the attributes and methods for basic
    authorization. It inherits from the Auth class.
    Args:
        Auth (class): The parent authentication class.
    """
    ...
    def extract_user_credentials(
        ...
        Args:
            self (obj): The Basic Auth instance.
    ...
    def user_object_from_credentials(
        ...
        """This method returns the User instance based on their email and password.
        Args:
            self (_type_): The Basic Auth instance.
